...
- 콘텐츠 스크립트가 기다려야 할 셀렉터: `__TODO__`

## Anti-bot 메모

- __TODO__
- VIBE_EXTRACTION.md §8 적용: 슬러/혐오 표현은 `src/lib/safety/slurs.ts`(추후)에서 사전 필터링되어 시드/스크랩 결과에 들어오면 안 됨.

## 변경 이력

- 2026-06-07: initial skeleton.
